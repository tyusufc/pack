...
# ----------------------------------------
# 🔁 AUTO HUNT SYSTEM - Const Variables
# ----------------------------------------
StartAutoHunt = 0                    # Oto av aktif mi?
AutoHunt_Attack = 0                 # Etrafta biri varsa saldır
AutoHunt_HpThreshold = 40          # Can %40 altına düşünce pot kullan
AutoHunt_UseSkill = 1              # Skill slotlarını otomatik kullan
