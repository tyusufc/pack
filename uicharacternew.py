...
ENABLE_CONQUEROR_UI = app.ENABLE_CONQUEROR_UI
...
class CharacterWindow(ui.ScriptWindow):
	...
	def __BindObject(self):
		...
		if ENABLE_CONQUEROR_UI:
			...
			self.HTH_IMG.SAFE_SetStringEvent("MOUSE_OVER_IN", self.__ShowToolTip, localeInfo.STAT_TOOLTIP_IMG_CON)
			self.HTH_IMG.SAFE_SetStringEvent("MOUSE_OVER_OUT", self.__HideToolTip)

			self.INT_IMG.SAFE_SetStringEvent("MOUSE_OVER_IN", self.__ShowToolTip, localeInfo.STAT_TOOLTIP_IMG_INT)
			self.INT_IMG.SAFE_SetStringEvent("MOUSE_OVER_OUT", self.__HideToolTip)

			self.STR_IMG.SAFE_SetStringEvent("MOUSE_OVER_IN", self.__ShowToolTip, localeInfo.STAT_TOOLTIP_IMG_STR)
			self.STR_IMG.SAFE_SetStringEvent("MOUSE_OVER_OUT", self.__HideToolTip)

			self.DEX_IMG.SAFE_SetStringEvent("MOUSE_OVER_IN", self.__ShowToolTip, localeInfo.STAT_TOOLTIP_IMG_DEX)
			self.DEX_IMG.SAFE_SetStringEvent("MOUSE_OVER_OUT", self.__HideToolTip)
			...
			self.SUNGMA_STR_IMG.SAFE_SetStringEvent("MOUSE_OVER_IN", self.__ShowToolTip, localeInfo.STAT_TOOLTIP_SUNGMA_STR)
			self.SUNGMA_STR_IMG.SAFE_SetStringEvent("MOUSE_OVER_OUT", self.__HideToolTip)

			self.SUNGMA_HP_IMG.SAFE_SetStringEvent("MOUSE_OVER_IN", self.__ShowToolTip, localeInfo.STAT_TOOLTIP_SUNGMA_HP)
			self.SUNGMA_HP_IMG.SAFE_SetStringEvent("MOUSE_OVER_OUT", self.__HideToolTip)

			self.SUNGMA_MOVE_IMG.SAFE_SetStringEvent("MOUSE_OVER_IN", self.__ShowToolTip, localeInfo.STAT_TOOLTIP_SUNGMA_MOVE)
			self.SUNGMA_MOVE_IMG.SAFE_SetStringEvent("MOUSE_OVER_OUT", self.__HideToolTip)

			self.SUNGMA_IMMUNE_IMG.SAFE_SetStringEvent("MOUSE_OVER_IN", self.__ShowToolTip, localeInfo.STAT_TOOLTIP_SUNGMA_IMMUNE)
			self.SUNGMA_IMMUNE_IMG.SAFE_SetStringEvent("MOUSE_OVER_OUT", self.__HideToolTip)
			...
			self.HEL_IMG.SAFE_SetStringEvent("MOUSE_OVER_IN", self.__ShowToolTip, localeInfo.STAT_TOOLTIP_HP)
			self.HEL_IMG.SAFE_SetStringEvent("MOUSE_OVER_OUT", self.__HideToolTip)

			self.SP_IMG.SAFE_SetStringEvent("MOUSE_OVER_IN", self.__ShowToolTip, localeInfo.STAT_TOOLTIP_SP)
			self.SP_IMG.SAFE_SetStringEvent("MOUSE_OVER_OUT", self.__HideToolTip)

			self.ATT_IMG.SAFE_SetStringEvent("MOUSE_OVER_IN", self.__ShowToolTip, localeInfo.STAT_TOOLTIP_ATT)
			self.ATT_IMG.SAFE_SetStringEvent("MOUSE_OVER_OUT", self.__HideToolTip)

			self.DEF_IMG.SAFE_SetStringEvent("MOUSE_OVER_IN", self.__ShowToolTip, localeInfo.STAT_TOOLTIP_DEF)
			self.DEF_IMG.SAFE_SetStringEvent("MOUSE_OVER_OUT", self.__HideToolTip)
			...
			self.MSPD_IMG.SAFE_SetStringEvent("MOUSE_OVER_IN", self.__ShowToolTip, localeInfo.STAT_TOOLTIP_MOVE_SPEED)
			self.MSPD_IMG.SAFE_SetStringEvent("MOUSE_OVER_OUT", self.__HideToolTip)

			self.ASPD_IMG.SAFE_SetStringEvent("MOUSE_OVER_IN", self.__ShowToolTip, localeInfo.STAT_TOOLTIP_ATT_SPEED)
			self.ASPD_IMG.SAFE_SetStringEvent("MOUSE_OVER_OUT", self.__HideToolTip)

			self.CSPD_IMG.SAFE_SetStringEvent("MOUSE_OVER_IN", self.__ShowToolTip, localeInfo.STAT_TOOLTIP_CAST_SPEED)
			self.CSPD_IMG.SAFE_SetStringEvent("MOUSE_OVER_OUT", self.__HideToolTip)

			self.MATT_IMG.SAFE_SetStringEvent("MOUSE_OVER_IN", self.__ShowToolTip, localeInfo.STAT_TOOLTIP_MAG_ATT)
			self.MATT_IMG.SAFE_SetStringEvent("MOUSE_OVER_OUT", self.__HideToolTip)

			self.MDEF_IMG.SAFE_SetStringEvent("MOUSE_OVER_IN", self.__ShowToolTip, localeInfo.STAT_TOOLTIP_MAG_DEF)
			self.MDEF_IMG.SAFE_SetStringEvent("MOUSE_OVER_OUT", self.__HideToolTip)

			self.ER_IMG.SAFE_SetStringEvent("MOUSE_OVER_IN", self.__ShowToolTip, localeInfo.STAT_TOOLTIP_REACTION)
			self.ER_IMG.SAFE_SetStringEvent("MOUSE_OVER_OUT", self.__HideToolTip)
	...
	nextState = ("STATUS", "SKILL", "EMOTICON", "QUEST")
	def OnMouseWheel(self, delta):
		try:
			current_index = self.nextState.index(self.state)
		except ValueError:
			current_index = 0

		if delta < 0:
			next_index = min(current_index + 1, len(self.nextState)-1)
			next_element = self.nextState[next_index]
			self.__OnClickTabButton(next_element)
		else:
			prev_index = max(current_index - 1, 0)
			prev_element = self.nextState[prev_index]
			self.__OnClickTabButton(prev_element)
	...
	def __LoadWindow(self):
		...
		try:
			if localeInfo.IsARABIC():
				self.__LoadScript("UIScript/characterwindownewae.py")
				...
				self.__LoadScript("UIScript/characterwindownew.py")

			if not app.ENABLE_CONQUEROR_LEVEL:
				self.GetChild("passive_expanded_btn").Hide()
				self.GetChild("change_base_button").Hide()
				self.GetChild("change_conqueror_button").Hide()
				# self.GetChild("Skill_Board").Hide()
				# self.GetChild("Skill_Board_expanded").Hide()
	...
	def RefreshStatus(self):
		...
		try:
			...
			if not app.ENABLE_CONQUEROR_LEVEL:
				self.GetChild("sungma_str_value").SetText(str("0"))
				self.GetChild("sungma_hp_value").SetText(str("0"))
				self.GetChild("sungma_move_value").SetText(str("0"))
				self.GetChild("sungma_immune_value").SetText(str("0"))
	...
	if ENABLE_CONQUEROR_UI:
		def __ShowToolTip(self, tooltip_text):
			self.toolTipConquerorInfoButton.ClearToolTip()
			self.toolTipConquerorInfoButton.AutoAppendTextLine(tooltip_text)
